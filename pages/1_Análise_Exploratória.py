...
if not df_returns_analysis_app.empty:
    ...
    st.markdown("Picos neste gráfico indicam períodos de alta incerteza e instabilidade nos preços, frequentemente ligados a eventos econômicos ou geopolíticos significativos, exemplo a queda do preço entre 2020 e 2021 devido a pandemia de COVID-19.")
else:
